...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <>
      ...
      {/* Sidebar Container */}
      <motion.aside
        className={`fixed top-0 left-0 z-50 h-[100dvh] bg-white dark:bg-zinc-900 border-r border-gray-200 dark:border-zinc-800 w-72 shadow-2xl flex flex-col`}
        initial={false}
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar flex flex-col">
          ...
          <div className="p-4 border-t border-gray-200 dark:border-zinc-800 bg-gray-50 dark:bg-zinc-900/50 mt-auto shrink-0">
            ...
            <div className="mt-3 text-center">
              <span className="text-[10px] text-gray-500/80 dark:text-zinc-600 font-medium tracking-wide">
                Desarrollado por Javi Barrero
              </span>
            </div>
          </div>
        </div>
